...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
         ...
         * The loadFeed() is asynchronous. This test uses
    ...
    describe('New Feed Selection', function() {
         ...
         */
         ...
         beforeEach(function(done) {
           loadFeed(0, function() {
             feedSection = $('.feed').html();
               loadFeed(1, function() {
                 newFeedSection = $('.feed').html();
                 done();
             });
         ...
         it('New feed content diffrent than old feed content', function() {
            expect(feedSection).not.toBe(newFeedSection);
